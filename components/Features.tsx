  ...
  const items = [
    {
      subtitle: "EDUCAÇÃO",
      title: "XPACE\nESCOLA",
      description: "O núcleo do nosso universo. Focada no aprendizado técnico e artístico da dança, com metodologia exclusiva para desenvolver alunos do zero ao avançado.",
      icon: "school",
    ...
    },
    {
      subtitle: "COMPETIÇÃO",
      title: "XPACE\nCOMPANY",
      description: "Nossa CIA de alta performance. Um grupo seleto focado em competições, representação em festivais e desenvolvimento de carreira artística profissional.",
      icon: "trophy",
    ...
    },
    {
      subtitle: "CRIATIVO",
      title: "XPACE\nPROJECTS",
      description: "O braço de inovação. Laboratório criativo dedicado a produções audiovisuais, workshops especiais e projetos conceituais que unem dança e arte visual.",
      icon: "movie_creation",
      borderColor: "border-tertiary",
      iconColor: "text-tertiary",
      hoverShadow: "hover:shadow-xl" // Blue/Generic shadow
    },
    {
      subtitle: "IMERSÃO",
      title: "XPERIENCE\nURBAN",
      description: "Nosso evento proprietário. Uma imersão total na cultura das danças urbanas, conectando a comunidade através de battles, workshops e showcases.",
      icon: "festival",
      borderColor: "border-cyber-pink",
      iconColor: "text-cyber-pink",
      hoverShadow: "hover:shadow-[0_0_20px_rgba(235,0,188,0.3)]" // Pink custom shadow
    }
  ];
