        ...
        <div className="flex justify-between items-center h-24">
          ...
          <Link to="/" className="flex-shrink-0 flex items-center group cursor-pointer" onClick={closeMenu} title="Voltar ao Hub">
            <div className="flex flex-col items-center justify-center transition-transform duration-300 group-hover:scale-105">
              <img src="/images/logo/XPACE%20PERFIL%20PRETO.png?v=2" alt="XPACE Logo" className="h-10 w-auto dark:hidden" />
              <img src="/images/logo/XPACE%20PERFIL%20BRANCO.png?v=2" alt="XPACE Logo" className="h-10 w-auto hidden dark:block" />
            </div>
          </Link>
          ...
          <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            ...
            >
              <div className="absolute -inset-0.5 bg-gradient-to-r from-primary to-secondary rounded-sm blur opacity-75 group-hover:opacity-100 transition duration-500 group-hover:duration-200"></div>
