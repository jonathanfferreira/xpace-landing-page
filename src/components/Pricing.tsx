      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 items-stretch mb-20">
          ...
          <motion.div 
            ...
            className="md:col-span-3 border-2 border-[#FFD700] p-1 bg-gradient-to-r from-[#FFD700] via-[#FDB931] to-[#FFD700] relative transform hover:scale-[1.01] transition-transform duration-300 shadow-[0_0_30px_rgba(255,215,0,0.3)] z-20 mb-8 rounded-3xl"
          >
          ...
          {/* ANUAL (Hero/Ticket) */}
          <TiltCard className="md:-translate-y-6">
            <div className="border-2 border-primary p-1 bg-gradient-to-br from-primary via-cyber-pink to-secondary relative transform shadow-2xl shadow-primary/20 clip-card z-10 hover:scale-[1.02] transition-transform duration-300 h-full">
