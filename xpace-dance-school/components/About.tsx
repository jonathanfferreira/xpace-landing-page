                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div className="space-y-6 text-gray-600 dark:text-gray-300 font-body text-sm md:text-base leading-relaxed text-justify">
                            <p>
                                A história da <strong>XPACE</strong> é marcada por uma ascensão meteórica. O que começou em <strong>março de 2023</strong> como um projeto artístico fundado por <strong>Ruan Amorim</strong>, transformou-se em tempo recorde na maior potência das danças urbanas da região.
                            </p>
                            <p>
